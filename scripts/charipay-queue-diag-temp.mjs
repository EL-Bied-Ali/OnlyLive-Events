...
if (!apiKey) {
  console.log("CHARIPAY_QUEUE_DIAG=" + JSON.stringify({ ok:false, error:"missing_api_key" }));
  process.exit(0);
}
...
console.log("CHARIPAY_QUEUE_DIAG=" + JSON.stringify({
  ...
  eventsHttpStatus: eventsRes.status,
