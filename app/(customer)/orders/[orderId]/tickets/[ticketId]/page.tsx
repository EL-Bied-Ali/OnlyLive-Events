  ...
  return (
    <main className={`customer-ticket-page customer-ticket-${ticket.status}`}>
      <header className="customer-ticket-header">
        ...
        <Link href={`/orders/${orderId}`} className="customer-ticket-back">← Commande {ticket.orderItem.order.orderNumber}</Link>
      </header>
      ...
      <article className="customer-ticket-pass">
        <div className="customer-ticket-details">
          <div className={`customer-ticket-state customer-ticket-state-${ticket.status}`}>
